...
<a data-mini="true" data-inline="true" data-role="button" data-transition="slide" href="index.php?uc=dash&action=nouveau" data-theme="c"><span class="ui-btn-inner">
<span class="ui-btn-text">Nouveau bug</span></span></a>
...
<script>
    jQuery(function($){
        ...
        $( "body" ).on( "click",'option', function() {
            ...
            $.ajax({
                type:"POST",
                url:<?php echo $_SERVER['DOCUMENT_ROOT']?>"./util/traitements_JSON.php",
                dataType:"json",
